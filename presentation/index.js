      ...
      <Spectacle theme={theme}>
        <Deck transition={slideTransition} transitionDuration={500}>
          ...
          <Slide transition={slideTransition}>
            ...
            <List>
              <Appear><ListItem>Needed a table for custom CMS. No proper solutions at the time.</ListItem></Appear>
          ...
          <Slide transition={slideTransition}>
            ...
            <List>
              ...
              <Appear><ListItem>Move <b>react-edit</b> to a repository of its own and make it more useful standalone</ListItem></Appear>
            </List>
          </Slide>
          ...
          <Slide transition={slideTransition}>
            ...
            <List>
              ...
              <Appear><ListItem>Two versioning modes: fixed (think Babel) and independent</ListItem></Appear>
              <Appear><ListItem>Good to have - <Link href="https://github.com/lerna/lerna/issues/298">hybrid mode</Link> to enable incubation</ListItem></Appear>
